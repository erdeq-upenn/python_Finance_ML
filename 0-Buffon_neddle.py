...
The probability of crossing the line is:
    {\displaystyle p={\frac {2}{\pi }}{\frac {l}{t}}.}

This can use a Monte Carlo method to solve for Pi.
    https://en.wikipedia.org/wiki/Buffon%27s_needle_problem
also refer to this github repo
    https://github.com/SamuelHunter/Buffon
...
UPDATE_FREQ = 1000   #number of needles to toss before updating plot (natural numbers)
